Obviously copied from https://github.com/DinoMan/speech-driven-animation. Trying out just with photos because it seems easier than doing the 3D version just yet.
